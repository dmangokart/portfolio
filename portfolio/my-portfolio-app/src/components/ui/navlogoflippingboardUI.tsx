...
export function NavLogoFlippingBoard({
  rows,
  text,
  className,
  ...
  return (
    <div
      className={cn(
        "relative w-full rounded-lg bg-neutral-100 p-1 shadow-md md:rounded-lg md:p-1.5 dark:bg-neutral-900 dark:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.4)]",
        className,
      )}
    >
      <div
